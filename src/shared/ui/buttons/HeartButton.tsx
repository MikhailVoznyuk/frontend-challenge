...
export function HeartButton({isActive, onClick, className}: Props) {
        ...
        >
            ...
            >
                <svg
                    ...
                    aria-hidden="true"
                    className={twMerge(
                    'absolute inset-0 size-full fill-current transition-opacity',
                        (isHover || isActive) ? 'opacity-0' : 'opacity-100 group-hover:opacity-0'
                    )}
                >
                    ...
                    <svg
                        ...
                        className={twMerge(
                        'absolute inset-0 size-full fill-current transition-opacity',
                            (isHover || isActive) ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                        )}
                    >
                    <path d="M33 6C29.52 6 26.18 7.62 24 10.18C21.82 7.62 18.48 6 15 6C8.84 6 4 10.84 4 17C4 24.56 10.8 30.72 21.1 40.08L24 42.7L26.9 40.06C37.2 30.72 44 24.56 44 17C44 10.84 39.16 6 33 6Z" />
                </svg>
            </span>
        </button>
    )
